...
/**
 *  EngineState class.  Manages the state of the engine in terms of editing the world or running the
 * game with editing disabled.  New editing features will need to be added here.
 */
