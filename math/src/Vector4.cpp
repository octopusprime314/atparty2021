...
float* Vector4::getFlatBuffer() { return _vec; }
...
float Vector4::getx() const { return _vec[0]; }

float Vector4::gety() const { return _vec[1]; }

float Vector4::getz() const { return _vec[2]; }

float Vector4::getw() const { return _vec[3]; }
