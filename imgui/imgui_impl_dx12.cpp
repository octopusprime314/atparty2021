...
//  2018-06-12: DirectX12: Moved the ID3D12GraphicsCommandList4* parameter from NewFrame() to RenderDrawData().
...
static void ImGui_ImplDX12_SetupRenderState(ImDrawData* draw_data, ID3D12GraphicsCommandList4* ctx, FrameResources* fr)
{
...
// Render function
void ImGui_ImplDX12_RenderDrawData(ImDrawData* draw_data, ID3D12GraphicsCommandList4* ctx)
{
...
static void ImGui_ImplDX12_CreateFontsTexture()
{
    ...
    // Upload texture to graphics system
    {
        ...
        ID3D12GraphicsCommandList4* cmdList = NULL;
