/*
 * EventSubscriber is part of the ReBoot distribution
...
/**
 *  EventSubscriber class.  Class to derive from if a class wants to receive
...
class EventSubscriber
{
  ...
  public:
    EventSubscriber();
    EventSubscriber(ViewEvents* eventWrapper);
