...
int  Animation::getFrameCount() { return _animationFrames; }
void Animation::setFrames(int animationFrames) { _animationFrames = animationFrames; }
...
std::vector<Matrix>* Animation::getBones() { return _boneTransforms[_currentAnimationFrame]; }

std::vector<std::vector<int>>* Animation::getBoneIndexes() { return _boneIndexes; }

std::vector<std::vector<float>>* Animation::getBoneWeights() { return _boneWeights; }
...
std::vector<SkinningData>& Animation::getSkins() { return _skinData; }
